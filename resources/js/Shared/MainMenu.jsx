...
export default ({ className }) => {
  return (
    <div className={className}>
      ...
      <MainMenuItem text="Tagihan" link="bills.index" icon={<CurrencyDollarOutline className="w-6 h-6 mr-4"/>} />
      <div className="mt-6 mb-4 text-sm font-semibold tracking-wide text-indigo-300 uppercase">Bisnis</div>
      <MainMenuItem text="Penginapan" link="lodgings.index" icon={<ArchiveOutline className="w-6 h-6 mr-4"/>} />
      <MainMenuItem text="Penagihan" link="invoices.index" icon={<CreditCardOutline className="w-6 h-6 mr-4"/>} />
      <MainMenuItem text="Pembayaran" link="payments.index" icon={<CashOutline className="w-6 h-6 mr-4"/>} />
    </div>
  );
};